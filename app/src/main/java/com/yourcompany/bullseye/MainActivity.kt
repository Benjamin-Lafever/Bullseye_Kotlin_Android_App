...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.hitMeButton.setOnClickListener {
            Log.i("Button Click Event", "You clicked the button")
            showResult()
        }
        ...
        binding.playerSelectSeekBar.setOnSeekBarChangeListener(object :
    ...
    private fun pointsForCurrentRound(): Int {
        val maxScore = 100
        val difference = abs(differenceAmount())
        var bonus = 0
    ...
    private fun startNewGame(){
        ...
        binding.gameRoundTextView?.text = currentRound.toString()
        binding.targetTextView.text = targetValue.toString()
        binding.playerSelectSeekBar.progress = sliderValue
